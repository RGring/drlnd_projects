...
agent = Agent(state_size=state_size, action_size=action_size, seed=0, dueling=dueling)


def dqn(n_episodes=2000, max_t=1000, eps_start=0.1, eps_end=0.0001, eps_decay=0.995):
    """Deep Q-Learning.
...
plt.xlabel('Episode #')
#plt.show()
plt.savefig('../figures/dueling.jpg')
